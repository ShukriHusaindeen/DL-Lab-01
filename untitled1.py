...
Original file is located at
    https://colab.research.google.com/drive/1C8Amsh1iaVzuPSWCt3_89Wydu6sYZxFX
"""
...
data = pd.read_csv('/content/drive/MyDrive/Dataset/Au_nanoparticle_dataset.csv')  # Update path accordingly
